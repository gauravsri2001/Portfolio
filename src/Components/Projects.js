...
//         <div className={Styles.sectionText}>
//           Following projects showcase my skills and experience through a real-world example of my work. Each project is briefly described with links to code repositories and live demos. It reflects my ability to solve complex problems, work with different technologies, and manage projects effectively.
//         </div>
//       </div>
...
//                 <div className='h-[40px] w-[40px] m-3 bg-slate-50 rounded-full shadow-lg shadow-violet-500 flex justify-center items-center'>
//                   <a href={project.source_deploy_link} target='blank'>
//                     {/* Use SiVercel instead of SiNetlify */}
//                     <SiVercel className="text-3xl font-bold text-violet-600"></SiVercel>
//                   </a>
//                 </div>
